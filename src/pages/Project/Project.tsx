...
function Project() {
  ...
  const ProjectPhotos = [
    ...
    {
      photoLink: 'https://abdalrhman80.github.io/My-Portfolio/assets/images/overview-Images/freshCart/freshCart2.png'
    },
    {
      photoLink: 'https://abdalrhman80.github.io/My-Portfolio/assets/images/overview-Images/freshCart/freshCart3.png'
    },
    {
      photoLink: 'https://abdalrhman80.github.io/My-Portfolio/assets/images/overview-Images/freshCart/freshCart4.png'
    },
    {
      photoLink: 'https://abdalrhman80.github.io/My-Portfolio/assets/images/overview-Images/freshCart/freshCart5.png'
    },
    {
      photoLink: 'https://abdalrhman80.github.io/My-Portfolio/assets/images/overview-Images/freshCart/freshCart6.png'
    },
    {
      photoLink: 'https://abdalrhman80.github.io/My-Portfolio/assets/images/overview-Images/freshCart/freshCart7.png'
    },
  ]
  return (
                ...
                {skills.map((skill, index) => (
                  <a key={index} href="#" className="technology">
                    <div className="technology-info">
                      <img src={skill.image} alt="" className="technology-image" />
                      <span className="technology-name">{skill.skill_item}</span>
                    </div>
                  </a>
                ))}
              </div>
